...
public class MainActivity extends AppCompatActivity implements OneClickPaymentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price = bundle.getString("price1");
        priceToPay=(TextView)findViewById(R.id.editTextAmount);
        priceToPay.setText(price);
        amount = ((TextView) findViewById(R.id.editTextAmount)).getText().toString();

        add=(EditText) findViewById(R.id.editAddress);

        pin=(EditText) findViewById(R.id.editPincode);
...
/*        list.add("Test");
        ...
        environmentSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (environmentSpinner.getSelectedItem().equals("Production")) {
                    ...
                    */
                    ((TextView) findViewById(R.id.editTextMerchantKey)).setText("0MQaQP");
                }
                else{
                    //set the test key in test environment
                    ((TextView) findViewById(R.id.editTextMerchantKey)).setText("gtKFFx");
    ...
    public void navigateToBaseActivity(View view) {
        merchantKey = ((TextView) findViewById(R.id.editTextMerchantKey)).getText().toString();
        ...
        sUsername = add.getText().toString();
        if (sUsername.matches("")) {
            Toast.makeText(this, "You did not enter Address", Toast.LENGTH_SHORT).show();
            return;
        }

        pinc = pin.getText().toString();
        if (pinc.matches("")) {
            Toast.makeText(this, "You did not enter Pincode", Toast.LENGTH_SHORT).show();
            return;
        }
